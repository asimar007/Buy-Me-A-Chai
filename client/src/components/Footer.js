        ...
        <footer className="text-black py-4">
            <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="flex justify-center pt-4 lg:pt-0 lg:col-end-13">
                    <a rel="noopener noreferrer" href="https://www.linkedin.com/in/asimar007/" title="Linkedin" className="flex items-center justify-center w-10 h-10 rounded-full dark:text-gray-50 mr-4" target="_blank">
                        <svg
                    ...
                    <a rel="noopener noreferrer" href="https://x.com/asim_ar007" title="X" className="flex items-center justify-center w-10 h-10 rounded-full dark:text-gray-50 mr-4" target="_blank">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a rel="noopener noreferrer" href="https://github.com/asimar007" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:text-gray-50" target="_blank">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                            y="0px"
